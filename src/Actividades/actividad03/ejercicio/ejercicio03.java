...
//		e) Método sumar(): calcular la suma de los números y devolver el resultado al Ejercicio1.
//		f) Método restar(): calcular la resta de los números y devolver el resultado al Ejercicio1
//
//		g) Método multiplicar(): primero valida que no se haga una multiplicación por cero, si
//		fuera a multiplicar por cero, el método devuelve 0 y se le informa al usuario el error.
//		Si no, se hace la multiplicación y se devuelve el resultado al Ejercicio1
//		h) Método dividir(): primero valida que no se haga una división por cero, si fuera a pasar
//		una división por cero, el método devuelve 0 y se le informa al usuario el error se le
//		informa al usuario. Si no, se hace la división y se devuelve el resultado al Ejercicio1.
